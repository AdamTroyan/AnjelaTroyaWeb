...
const faqs = [
  {
    question: "מה כולל שירות התיווך?",
    answer: "השירות כולל ליווי מלא — מאיתור נכס או שיווקו, דרך תיאום סיורים ומשא ומתן, ועד לסגירת העסקה. אני מעורבת בכל שלב ומוודאת שהכל מתנהל בשקיפות ובטחון.",
  },
  {
