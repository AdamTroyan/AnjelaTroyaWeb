          ...
          <footer className="border-t border-slate-200 bg-white">
            <div className="mx-auto flex w-full max-w-6xl flex-col items-center gap-2 px-6 py-6 text-center text-sm text-slate-500">
              ...
              <p className="max-w-3xl text-xs text-slate-500">
                המידע באתר להמחשה בלבד ואינו מהווה ייעוץ משפטי/פיננסי או הצעה
                מחייבת. ייתכנו טעויות ושינויים במחיר, בזמינות ובפרטים. מומלץ לבצע
                בדיקות עצמאיות טרם קבלת החלטה.
              </p>
