...
const translations: Record<Locale, TranslationObject> = {
  he: {
    site: {
      ...
      tagline: "תיווך נדל\"ן | אשקלון",
      footer: "ANJELA TROYA - תיווך נדל\"ן באשקלון",
    ...
    home: {
      heroKicker: "תיווך נדל\"ן באשקלון",
      heroTitle: "אנג׳לה טרויה — תיווך נדל\"ן עם לב",
      heroBody:
        "אני אנג׳לה טרויה, מתווכת נדל\"ן באשקלון כבר 5 שנים. חיה בעיר מעל 30 שנה, מכירה כל רחוב ושכונה. אני מאמינה שכל אדם מגיע לשירות מקצועי, אמין ושקוף — ועובדת מכל הלב כדי שהלקוחות שלי ירגישו בטוחים ויצאו מרוצים.",
      heroContact: "צור קשר",
      heroProperties: "צפייה בנכסים",
      aboutTitle: "אודות",
      aboutBody:
        "אני מלווה את הלקוחות שלי מהרגע הראשון ועד לרגע האחרון. מעורבת בכל פרט, זמינה בכל שלב, ופועלת בשקיפות מלאה כדי שתרגישו בטוחים בכל החלטה.",
      cardPrecisionTitle: "קשר אישי",
      cardPrecisionBody: "אני לא רק מתווכת — אני שם בשבילכם. זמינות מלאה, תקשורת ישירה והקשבה אמיתית לצרכים שלכם.",
      cardSupportTitle: "מקצועיות ואמינות",
      cardSupportBody: "ניסיון של 5 שנים בשוק האשקלוני, היכרות עמוקה עם הנכסים ותמחור מדויק שמביא תוצאות.",
    ...
    about: {
      title: "אודות",
      body:
        "אני אנג׳לה טרויה, מתווכת נדל\"ן באשקלון. חיה בעיר כבר מעל 30 שנה ופועלת בתחום התיווך 5 שנים. אני לא רק מתווכת — אני שם עם הלקוחות שלי בכל שלב. עובדת עם ישראלים ודוברי רוסית כאחד, ונותנת שירות מלא בשפתם.",
      highlights: [
  ...
  ru: {
    site: {
      title: "ANJELA TROYA | Недвижимость в Ашкелоне",
      description: "Профессиональные услуги по недвижимости в Ашкелоне — личное сопровождение, надежность и полная прозрачность.",
      tagline: "Недвижимость | Ашкелон",
      footer: "ANJELA TROYA - Недвижимость в Ашкелоне",
    ...
    home: {
      heroKicker: "Недвижимость в Ашкелоне",
      heroTitle: "Анжела Троя — недвижимость с душой",
      heroBody:
        "Меня зовут Анжела Троя, я риелтор в Ашкелоне уже 5 лет. Живу в городе более 30 лет, знаю каждый район. Я верю, что каждый заслуживает профессионального, честного и прозрачного обслуживания — и работаю от всей души, чтобы мои клиенты чувствовали себя уверенно.",
      heroContact: "Связаться",
      heroProperties: "Смотреть объекты",
      aboutTitle: "Обо мне",
      aboutBody:
        "Я сопровождаю своих клиентов с первого момента до последнего. Вовлечена в каждую деталь, доступна на каждом этапе и работаю полностью прозрачно.",
      cardPrecisionTitle: "Личный контакт",
      cardPrecisionBody: "Я не просто риелтор — я рядом с вами. Полная доступность, прямая связь и искреннее внимание к вашим потребностям.",
      cardSupportTitle: "Профессионализм и надежность",
      cardSupportBody: "5 лет опыта на рынке Ашкелона, глубокое знание объектов и точное ценообразование.",
    ...
    about: {
      title: "Обо мне",
      body:
        "Меня зовут Анжела Троя, я риелтор в Ашкелоне. Живу в городе уже более 30 лет и работаю в сфере недвижимости 5 лет. Я не просто риелтор — я рядом с клиентами на каждом этапе. Работаю с израильтянами и русскоговорящими, и предоставляю полный сервис на их языке.",
      highlights: [
        "Вовлечена в каждую деталь — от первого обращения до передачи ключей.",
        "Глубокое знание рынка Ашкелона — 5 лет опыта и 30 лет в городе.",
        "Обслуживание на иврите и русском — потому что язык это тоже уверенность.",
      ],
    },
    testimonials: {
      title: "Отзывы",
